% 17x10 img size
% Filter design for Marshall - PSO
...
save('MarshallPSOResultsFreqW.mat','w','H','Fs','respMSEres','fracOctMSEres','fracThirdMSEres','criticalMSEres','pearsonMSEres','spectDevMSEres');
